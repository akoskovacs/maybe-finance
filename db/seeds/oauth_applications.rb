# Create OAuth applications for Finachy's first-party apps
# These are the only OAuth apps that will exist - external developers use API keys

# Finachy iOS App
ios_app = Doorkeeper::Application.find_or_create_by(name: "Finachy iOS") do |app|
  app.redirect_uri = "finachy://oauth/callback"
