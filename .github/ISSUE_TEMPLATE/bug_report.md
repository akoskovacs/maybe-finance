...
- [ ] I have searched [existing issues](https://github.com/finachium/finachy/issues?q=is:issue) and [discussions](https://github.com/finachium/finachy/discussions) to ensure this is not a duplicate issue

### How are you using Finachy?

- [ ] I am a paying Finachy customer (hosted version)
  - Paying Finachy users can also open requests in Intercom (if there is sensitive info involved)
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of Finachy
...
Be as specific as possible so Finachy maintainers can quickly reproduce the bug you're experiencing.
